...
class ApiConstants {
  ...
  static const String baseUrl = 'http://192.168.1.135:6789';
  ...
  static const String notificationsMarkRead = '$baseUrl/api/notifications/mark-all-read/';
  ...
  static const String frsClearNotifications = '$baseUrl/api/frs/clear-notifications';
  static const String frsFaceRequests = '$baseUrl/api/frs/face-requests';
  static const String frsHandleFaceRequest = '$baseUrl/api/frs/handle-face-request';
