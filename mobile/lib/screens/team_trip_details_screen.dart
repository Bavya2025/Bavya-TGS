  ...
  Widget _buildEmptyState() {
    return Center(
      child: Column(
        ...
        children: [
          Icon(Icons.map_outlined, size: 64, color: Colors.black.withValues(alpha: 0.1)),
  ...
  Widget _buildTripCard(Map<String, dynamic> trip) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF0F1E2A).withValues(alpha: 0.06),
            blurRadius: 24,
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  ...
                  colorFilter: ColorFilter.mode(
                    const Color(0xFF0F1E2A).withValues(alpha: 0.6),
                    BlendMode.darken,
                  ),
                ),
              ),
