...
class _ExpenseApprovalsScreenState extends State<ExpenseApprovalsScreen> {
  ...
  Future<void> _fetchTasks() async {
    ...
    try {
      ...
      setState(() {
        _tasks = tasks.where((t) => t['type'] == 'Expense').toList();
        _isLoading = false;
      });
    } catch (e) {
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: const Icon(Icons.wallet_rounded, size: 40, color: Color(0xFF94A3B8)),
          ),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: _infoRow(Icons.receipt_long_rounded, 'Claim Amount', '₹${task['cost']}'),
            ),
