...
class _ClaimSheetState extends State<ClaimSheet> {
  ...
  double get _totalAmount => _expenses.fold(
    0.0,
  ...
  Future<void> _handleSubmitClaim() async {
    if (_expenses.isEmpty) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('No expenses to claim!')));
      return;
    }
        ...
        if (!isLocked)
          SizedBox(
            ...
            child: ElevatedButton(
              onPressed: _isSubmitting || _expenses.isEmpty
                  ? null
                  : _handleSubmitClaim,
          ...
          _infoCard(
            ...
            'This claim has been submitted to your reporting authority. Further updates will be reflected here.',
          ),
  ...
  Widget _summaryCard() {
    return Container(
      ...
      child: Column(
        children: [
          Text(
            'Total Claimable Amount'.toUpperCase(),
            style: GoogleFonts.inter(
              fontSize: 11,
              fontWeight: FontWeight.w800,
          ...
          Text(
            '${_expenses.length} Expense Line items detected',
            style: GoogleFonts.inter(
              fontSize: 12,
          ...
          (exp) => Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  '₹${NumberFormat('#,##,###').format(double.tryParse(exp['amount'].toString()) ?? 0)}',
                  style: GoogleFonts.inter(
                    fontWeight: FontWeight.w900,
                    fontSize: 14,
                    color: const Color(0xFF0F172A),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            Text(
              'Claims can only be filed once the trip has been Approved or Completed.',
